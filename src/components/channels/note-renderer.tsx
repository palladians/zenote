...
import { CheckIcon, PencilIcon, StarIcon, StarOffIcon } from 'lucide-react'
...
export const NoteRenderer = ({ note, short = false }: { note: NoteProps, short?: boolean }) => {
      ...
      <div className="flex flex-1 flex-col gap-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4 text-sm">
            ...
            <NextLink href={`/notes/${note.id}`} className="text-sm">
              {format(note.createdAt ?? 0, 'dd.mm.yyyy hh:mm')}
            </NextLink>
          </div>
